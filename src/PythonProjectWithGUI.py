...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.listening_button = customtkinter.CTkButton(self.slider_progressbar_frame, width = 200, height = 100, corner_radius=100, text = "Always On", command = self.calling)
        ...
        self.Name_Of_Maker_label = customtkinter.CTkLabel(self.checkbox_slider_frame, text="Shagun Yadav | Alok Yadav", font=customtkinter.CTkFont(size=17, weight="bold"), text_color=("cyan", "#09f0f0"))
        self.Name_Of_Maker_label.grid(row=1, column=0, padx=20, pady=(10, 0))
        self.Name_Of_Maker_label = customtkinter.CTkLabel(self.checkbox_slider_frame, text="Nitesh Mishra | Aryan Pathak", font=customtkinter.CTkFont(size=17, weight="bold"), text_color=("cyan", "#09f0f0"))
        self.Name_Of_Maker_label.grid(row=2, column=0, padx=20, pady=(10, 0))
        # self.Name_Of_Maker_label = customtkinter.CTkLabel(self.checkbox_slider_frame, text="Nitesh Mishra", font=customtkinter.CTkFont(size=17, weight="bold"), text_color=("cyan", "#09f0f0"))
        ...
        self.Name_Of_Guide_label = customtkinter.CTkLabel(self.checkbox_slider_frame, text="Dr. Seema", font=customtkinter.CTkFont(size=17, weight="bold"), text_color=("cyan", "#09f0f0"))
